    ...
    <div className='border-2 rounded-lg border-dotted border-[#4A4453] p-4 text-[#4A4453]'>
      <form ref={form} onSubmit={sendEmail} className="bg-transparent col-span-4">
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          <div>
            <label>Name</label>
            <input type="text" name="name" className="bg-transparent border-b border-[#4A4453] w-full" />
          </div>
          <div>
            <label>Email</label>
            <input type="email" name="email" className="bg-transparent border-b border-[#4A4453] w-full" />
          </div>
          <div className='md:col-span-2'>
            <label>Message</label>
            <textarea name="message" className="bg-transparent border-b border-[#4A4453] w-full h-32" />
          </div>
          <div className='md:col-span-2'>
